...
public class StringQuiz03 {
	...
	public static void main(String[] args) {
		...
		/*
	    1. palindromeCheck()함수는 매개변수로 String 값을 받아, 회문 여부를 검사하는 static 메서드입니다.
	    ...
	    * 문장의 길이의 중간값을 구하세요. 
	    * 첫문장과, 마지막 문장을 비교하며 중간으로 이동
	    * for문에서 charAt()을 사용해서 반대로 잘라 붙이세요. (or 빌더를 이용 하여 문자를 뒤집어 비교)
	    */
		
		System.out.println(palindromeCheck("아 좋다 좋아"));
		System.out.println(palindromeCheck("다시 합창 합시다"));
		System.out.println(palindromeCheck("안녕하세요"));
		System.out.println(palindromeCheck("요시요시요요시요시요"));
